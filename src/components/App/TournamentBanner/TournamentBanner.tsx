...
const TournamentBanner: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Box width="72rem">
        <Typography variant="h1" noWrap color="primary.contrastText">
          {tournament}
        </Typography>
        <Typography variant="h3" noWrap color="primary.contrastText">
          {event}
        </Typography>
      </Box>
      <Button
      ...
      >
        <img src={startGGButton} alt="startgg" style={{ height: "4rem" }} />
      </Button>
    </Box>
  );
};
